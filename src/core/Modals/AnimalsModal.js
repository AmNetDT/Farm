                                ...
                                <Container className="m-0 p-1">
                                    ...
                                    <Row>
                                        ...
                                        <Col md={2} className=" p-0">
                                            ...
                                            <DefaultButton onClick={openEditGroupModal} style={{ borderColor: '#cccccc', color: '#666666' }}>
                                                Edit Group</DefaultButton>  
                                            <Button onClick={openDeleteModal} className="IconButton-MS" variant="secondary">
