...
<header className="header sticky">
    <nav className="navbar navbar-expand-lg px-4 py-2 bg-light border">
      <Link to="#" className="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead">
        <i className="icon-align-justify text-primary"></i></Link>
      <Link to="./index.js" className="navbar-brand text-uppercase text-dark">KEALUCK ERM</Link>
      <ul className="ml-auto d-flex align-items-center list-unstyled mb-0">

        <li className="nav-item dropdown mr-3"><Link id="notifications" to="#" data-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false" className="nav-link dropdown-toggle text-dark px-1">
            Username (USD)</Link>
          <div aria-labelledby="notifications" className="dropdown-menu"><Link to="#" className="dropdown-item">
        ...
        <li className="nav-item dropdown ml-auto">
          <Link id="userInfo" to="#" className="nav-link text-primary">
